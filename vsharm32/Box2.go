...
func (e *Encoder) box2(v *Box2) (err os.Error){
     ...
     if _, _, error := e.t.PointerCheck(unsafe.Pointer(v), "39669fca0f03e0d91bfcdb5b31049e29cc0c57106f280f6e92980e1ef521fe786dfb56f25656a3ccc6483ba87c9e2ba6b1c3f445a12379544e06e13ad91c98cd", uint64(unsafe.Sizeof(*v))); error == nil {
...
func (e *Encoder) any(a Any) (err os.Error){
	...
	if err != nil {
     ...
     case Box2:
     	hashByte, err := hex.DecodeString("39669fca0f03e0d91bfcdb5b31049e29cc0c57106f280f6e92980e1ef521fe786dfb56f25656a3ccc6483ba87c9e2ba6b1c3f445a12379544e06e13ad91c98cd")
	if err != nil {
	   return err
	}
     	// hashByte := []byte("39669fca0f03e0d91bfcdb5b31049e29cc0c57106f280f6e92980e1ef521fe786dfb56f25656a3ccc6483ba87c9e2ba6b1c3f445a12379544e06e13ad91c98cd")
     	// e.string("39669fca0f03e0d91bfcdb5b31049e29cc0c57106f280f6e92980e1ef521fe786dfb56f25656a3ccc6483ba87c9e2ba6b1c3f445a12379544e06e13ad91c98cd")
	err = e.SliceOfBytes(hashByte)
	if err != nil {
	   return err
	}
...
func (d *Decoder) any() (retValue *Any, error os.Error) {
	...
	if err != nil {
     ...
     case bytes.Equal(encodedHash, []byte("39669fca0f03e0d91bfcdb5b31049e29cc0c57106f280f6e92980e1ef521fe786dfb56f25656a3ccc6483ba87c9e2ba6b1c3f445a12379544e06e13ad91c98cd")):
...
func (t *Box2) CreateDirectory(fd syscall.Fd, name string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0x39,0x66,0x9f,0xca,0x0f,0x03,0xe0,0xd9,0x1b,0xfc,0xdb,0x5b,0x31,0x04,0x9e,0x29,0xcc,0x0c,0x57,0x10,0x6f,0x28,0x0f,0x6e,0x92,0x98,0x0e,0x1e,0xf5,0x21,0xfe,0x78,0x6d,0xfb,0x56,0xf2,0x56,0x56,0xa3,0xcc,0xc6,0x48,0x3b,0xa8,0x7c,0x9e,0x2b,0xa6,0xb1,0xc3,0xf4,0x45,0xa1,0x23,0x79,0x54,0x4e,0x06,0xe1,0x3a,0xd9,0x1c,0x98,0xcd, }  
       return goodmiddleman.CreateDirectory(fd, name, label, hash)
}
